...
const FEATURES = [
  ...
  { slug: 'seo_intelligence', name: 'SEO Intel', desc: 'Keyword research, domain analytics, competitive intelligence, cross-referencing', icon: Search, color: 'var(--red)', gradient: 'linear-gradient(135deg, var(--red) 0%, var(--purple) 100%)', path: '/seo-intelligence' },
